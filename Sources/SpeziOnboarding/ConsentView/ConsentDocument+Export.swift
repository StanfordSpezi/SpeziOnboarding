...
extension ConsentDocument {
    ...
    /// Creates the export representation of the ``ConsentDocument`` including all necessary consent.
    ///
    /// - Returns: The exported consent representation as a ``ConsentDocumentExportRepresentation``
    var exportRepresentation: ConsentDocumentExportRepresentation {
        get async {
            ...
            .init(
                ...
                signatureImage: self.blackInkSignatureImage,
                name: self.name,
