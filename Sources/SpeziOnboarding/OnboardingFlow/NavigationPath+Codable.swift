...
/// This is particularly useful for the ``OnboardingNavigationPath`` to identify the topmost element on SwiftUI's `NavigationPath` which is of type `OnboardingStep.Identifier`.
extension NavigationPath {
    ...
    /// Computed property that provides access to the last element within the `NavigationPath` as an `OnboardingStep.Identifier`.
